...
class CommunityContentFreeRecyclerViewAdapter(
    val mContext:Context,
    val mList: List<CommunityContentData>
): RecyclerView.Adapter<CommunityContentFreeRecyclerViewAdapter.CheerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CheerViewHolder {
        val row = LayoutInflater.from(mContext).inflate(R.layout.community_free_list_item, parent,false)
